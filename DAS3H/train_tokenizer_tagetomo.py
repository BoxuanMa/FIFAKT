...
df = pd.read_csv("E:\dataset_memory\d2020.csv", encoding="utf-8")[["word"]]

surface_form = df["word"]
...
print("Unique words (surface forms):", flush=True)

print(len(unique_lang_words), flush=True)
